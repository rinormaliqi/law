...
const AboutPage = () => {
  ...
  return (
    <div className="bg-gray-50 text-gray-800 min-h-screen">
      {/* Biography */}
      <section className="py-12 md:py-20 px-4 sm:px-6 md:px-16 lg:px-32 bg-white">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-bold mb-4 md:mb-6 text-[#1a3e6a]">
              {language === "en"
                ? "Meet Asdren Bytyqi"
                : language === "al"
          ...
          >
            <div className="absolute -inset-2 md:-inset-4 bg-blue-800 rounded-lg transform rotate-2 opacity-10"></div>
            <img
              src="profile.jpg"
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row items-start gap-8 md:gap-12">
            ...
            <div className="md:w-1/2">
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif font-bold mb-4 md:mb-6 text-[#1a3e6a]">{t.why.title}</h2>
              <p className="text-gray-700 mb-4 md:mb-6 text-sm sm:text-base">{t.why.description}</p>

              {/* Points */}
              <ul className="space-y-3 md:space-y-4 mb-6 md:mb-0">
                {t.why.points.map((point, index) => (
                  <li key={index} className="flex items-start">
                    <div className="bg-[#1a3e6a] p-1 rounded-full mr-3 mt-1 flex-shrink-0">
                      <div className="w-2 h-2 bg-white rounded-full"></div>
                    </div>
                    <span className="text-gray-800 text-sm sm:text-base">{point}</span>
                  </li>
                ))}
              </ul>

              {/* Technical Expertise */}
              <div className="mt-6 md:mt-8 p-4 md:p-6 bg-[#f0f4f8] rounded-lg border border-[#1a3e6a]/20">
                <h4 className="font-semibold mb-3 md:mb-4 text-[#1a3e6a] text-sm md:text-base">{t.why.technicalExpertise.title}</h4>
                <div className="grid grid-cols-2 gap-2 md:gap-3 text-xs md:text-sm">
                  {t.why.technicalExpertise.items.map((item, index) => (
                    <span key={index} className="bg-white px-2 py-1 md:px-3 md:py-1 rounded border border-[#1a3e6a]/20 text-[#1a3e6a] text-center">
                      {item}
                    </span>
                  ))}
                </div>
            ...
            <div className="md:w-1/2 space-y-4 md:space-y-6 mt-8 md:mt-0">
              {/* Experience Box */}
              <div className="bg-[#1a3e6a] text-white rounded-lg p-6 md:p-8 shadow-md relative overflow-hidden">
                <div className="text-center">
                  <div className="text-4xl md:text-5xl font-bold mb-2">25+</div>
                  <div className="text-lg md:text-xl">{t.stats.years}</div>
                  <div className="w-16 md:w-20 h-1 bg-white mx-auto my-3 md:my-4"></div>

                  <div className="grid grid-cols-2 gap-4 md:gap-6 mt-4 md:mt-6">
                    <div className="text-center">
                      <div className="text-2xl md:text-3xl font-bold">500+</div>
                      <div className="text-xs md:text-sm">{t.stats.cases}</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl md:text-3xl font-bold">95%</div>
                      <div className="text-xs md:text-sm">{t.stats.success}</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute bottom-0 right-0 opacity-10">
                  <svg width="150" height="150" viewBox="0 0 200 200" className="w-32 h-32 md:w-40 md:h-40">
              ...
              <div className="p-3 md:p-4 bg-[#e0edf7] border border-[#1a3e6a]/40 rounded-lg">
                <h4 className="font-semibold text-[#1a3e6a] mb-2 text-sm md:text-base">{t.why.kosovoExpertise.title}</h4>
                <ul className="text-xs md:text-sm text-[#1a3e6a] list-disc list-inside space-y-1">
      ...
      {/* Expertise */}
      <section className="py-12 md:py-20 px-4 sm:px-6 md:px-16 lg:px-32 bg-gradient-to-b from-gray-50 to-gray-100">
        <motion.div
          initial="hidden"
          animate="visible"
          variants={{
        ...
        >
          <h2 className="text-2xl sm:text-3xl font-bold mb-8 md:mb-16 text-center text-[#1a3e6a]">
            {language === "en"
              ? "Areas of Expertise"
              : language === "al"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
            <motion.div
              variants={fadeIn}
              whileHover={{ y: -5 }}
              className="bg-white p-6 md:p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border-t-4 border-[#1a3e6a]"
            >
              <div className="w-12 h-12 md:w-14 md:h-14 bg-blue-100 rounded-lg flex items-center justify-center mb-4 md:mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 md:h-8 md:w-8 text-[#1a3e6a]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 11c0 3.517-1.009 6.799-2.753 9.571m-3.44-2.04l.054-.09A13.916 13.916 0 008 11a4 4 0 118 0c0 1.017-.07 2.019-.203 3m-2.118 6.844A21.88 21.88 0 0015.171 17m3.839 1.132c.645-2.266.99-4.659.99-7.132A8 8 0 008 4.07M3 15.364c.64-1.319 1-2.8 1-4.364 0-1.457.39-2.823 1.07-4" />
                </svg>
              </div>
              <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4 text-[#1a3e6a]">
                {language === "en"
                  ? "Criminal Law"
                  : language === "al"
                  ? "E Drejta Penale"
            ...
            <motion.div
              ...
              className="bg-white p-6 md:p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border-t-4 border-[#1a3e6a]"
            >
              <div className="w-12 h-12 md:w-14 md:h-14 bg-indigo-100 rounded-lg flex items-center justify-center mb-4 md:mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 md:h-8 md:w-8 text-[#1a3e6a]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
